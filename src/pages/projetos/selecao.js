...
const MeusProjetos = () => {
  ...
  const handleDelete = async () => {
    try {
      if (selectedProject) {
        const response = await fetch(
          "https://styxx-api.w3vvzx.easypanel.host/api/deleteProjeto",
          {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
    ...
    <div>
      ...
      <div className="mp-container">
        ...
        >
          ...
          <h1 style={{ marginLeft: "25px", color: "gray" }}>
        ...
        <div className="mp-projects-grid">
          <div style={{ backgroundColor: "white" }} className="mp-project-card">
            ...
            <div className="mp-project-body">
              <p>
                <strong>
                  Os programas de fomento da Secretaria de Cultura e Economia
                  Criativa têm o objetivo de apoiar a realização de projetos
                  culturais, por meio da concessão de incentivos financeiros
          ...
          {storageUserDetails && storageUserDetails.idCidade == 3798 ? (
            ...
            >
              ...
              <div className="mp-project-body">
                <p>
                  <strong>
                    O objeto deste Edital é a Premiação de Mestres e Mestras e
                    Grupos e Coletivos das Culturas Tradicionais e Populares que
