...
import Header from '../components/Header/Header';import PrivateRoute from '../components/PrivateRoute';
        ...
        <Box sx={{ width: '50%', border: '1px solid #ddd', padding: '2rem', borderRadius: '8px', backgroundColor: '#f9f9f9' }}>
          ...
          {isLoading ? (
            ...
            <form onSubmit={handleSubmit}>
              ...
              <UploadField name="form-insc" label="Formulário De Inscrição" exampleLink="https://criarte.s3.us-east-2.amazonaws.com/public/EDITAL-05-ANEXO-2-FORMULARIO-DE-INSCRICAO.docx" exampleText="Baixar exemplo" />
              <UploadField name="portf" label="Portfólio / Curriculo Artístico" />
              <UploadField name="dec-rep" label="Declaração De Representação ( Opcional )" />
              <UploadField name="auto-dec-et" label="Autodeclaração étnico-racial e/ou de pessoa com deficiência" />
