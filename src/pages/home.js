...
const Home = () => {
            ...
            if (userDetails) {
                ...
                if (allowedUsers.includes(parsedUserDetails.usuario)) {
                    if (parsedUserDetails.tipoUsuario <= 1) {
                        ...
                        localStorage.setItem('userDetails', JSON.stringify(parsedUserDetails));
    ...
    const handleButtonClick = () => {
        window.open("https://criarte.s3.us-east-2.amazonaws.com/documents/edital-1.pdf");
    };
            ...
            <div>
                ...
                <div className='cityIdentifierContainer'>
                    <div style={{ display: 'flex' }}>
                        <p>Version: 1.71.3</p>
                        <p>Cidade: {storageUserDetails ? `${cityName} (${storageUserDetails.idCidade})` : 'Cidade Desconhecida'}</p>
                    </div>
                            ...
                            storageUserDetails && storageUserDetails.tipoUsuario !== 1 && (
                                <>
                                    <div style={{ position: 'relative', marginLeft: '10px' }}>
                                        <button onClick={toggleDropdown} style={{ backgroundColor: '#33959c', padding: '6px', color: 'white', cursor: 'pointer', border: 'none' }}>Trocar Cidade</button>
                                        {showDropdown && (
                                            <ul style={{ position: 'absolute', top: '30px', left: '0', minWidth: '200px', backgroundColor: 'white', padding: '10px', borderRadius: '5px', boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.1)' }}>
                                                <p style={{ padding: '5px 0', cursor: 'pointer' }} onClick={() => handleCityChange(3842)}>Serrana</p>
                                                <p style={{ padding: '5px 0', cursor: 'pointer' }} onClick={() => handleCityChange(3798)}>Santa Rita</p>
                                                <p style={{ padding: '5px 0', cursor: 'pointer' }} onClick={() => handleCityChange(3823)}>São José Do Rio Pardo</p>
                                                <p style={{ padding: '5px 0', cursor: 'pointer' }} onClick={() => handleCityChange(3357)}>Brodowski</p>
                                            </ul>
                                        )}
                                    </div>
                                    <img style={{ maxWidth: '30px', backgroundColor: '#b54435' }} src='https://cdn.icon-icons.com/icons2/1222/PNG/512/1492616967-31-shield-protection-safety-security-google_83401.png'></img>
                                    <p style={{ backgroundColor: '#b54435', padding: '4px', color: 'white', marginRight: '0', marginLeft: '0' }}>Supervisor</p>
                                </>
                            )
                        }
                    </div>
                    ...
                    <section className="container_opcoes">
                        ...
                        <div className="container_ajuda">
                            <a href="#" className="opcao_link">
                                <h3><i className="bi bi-journal-check"></i> Ajuda</h3>
                            ...
                            storageUserDetails && storageUserDetails.tipoUsuario > 1 && (
                                <div className="container_ajuda">
                                    <a href="/admin/painel" className="opcao_link">
                                        <h3><i className="bi bi-journal-check"></i> Gestão</h3>
                    ...
                    <section className="container_banner">
                        {
                            storageUserDetails ? (
                                (storageUserDetails.idCidade === 3842) ? (
                                    <div>
                                        <img className="banner_img" style={{ display: 'flex' }} src="https://styxx-public.s3.sa-east-1.amazonaws.com/pnab-logo.png" alt="ADICIONAR BANNER" />

                                        <h1 className="banner_titulo">EDITAL DE CHAMAMENTO PÚBLICO Nº 001/2024 - SCET</h1>
                                        ...
                                        <button onClick={handleButtonClick} style={{ marginTop: '20px', minWidth: '100%' }} className="btn-detalhes">
                                            Ver detalhes
                                        </button>
                                    </div>
                                    ...
                                    <div>
                                        <h1 style={{ backgroundColor: 'white', padding: '20px', borderRadius: '10px' }} className="banner_titulo">
                                            Inscrições não estão disponíveis para sua cidade.
                                        </h1>
                                    </div>
                                )
                            ) : (
                                <h1 className="banner_titulo">Nenhum edital encontrado para sua região.</h1>
                            )
                        }
                    </section>
                </section>
