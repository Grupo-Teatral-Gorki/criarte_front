    ...
    <div className="form-page">
      <div className="form-container">
        ...
        <Typography variant="body2" className="form-description">
          Direitos autorais, fonomecânicos ou conexos, da propriedade do acervo,
          do imóvel ou de qualquer bem envolvido no projeto, cuja execução
          demande direito autoral ou patrimonial.
        </Typography>
                ...
                direitos.map((direito, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell>
                      ...
                      >
                        <MenuItem
                          onClick={() => handleShowEditForm(currentIndex)}
                        >
                          <EditIcon /> Editar
                        </MenuItem>
                        <MenuItem
                          onClick={() => handleDeleteDireito(currentIndex)}
                        >
                          <DeleteIcon /> Excluir
                        </MenuItem>
                      </Menu>
